...
- 🛠️ **Custom Exercises**: Create and customize exercises tailored to your needs.
...
- 🖥️ **Frontend**: [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/)
- ⚙️ **Backend**: [ASP.NET Core](https://dotnet.microsoft.com/)
