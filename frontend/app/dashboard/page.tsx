...
import { formatTotalWorkoutsDuration, GetWorkoutTime, lbsToKgs } from '../global components/Library/utilFunctions';
    ...
    return (
        <PageLayout activePage='/dashboard'>
            ...
            <ul className='grid grid-cols-2 gap-4 mt-5'>
                <li className='flex flex-col justify-center items-center p-4 bg-black rounded-3xl shadow-md'>
                ...
                <li className='flex flex-col justify-center items-center p-4 bg-black rounded-3xl shadow-md'>
                    ...
                    <span>{data.avgWorkoutVolume.toFixed(2)} lbs / {lbsToKgs(data.avgWorkoutVolume)} kgs</span>
                </li>
                <li className='flex flex-col justify-center items-center p-4 bg-black rounded-3xl shadow-md'>
